        ...
        <div className="row">
            <div className="col-2">
                <div className="card ">
                 ...
                 <div style={{width: "75px",height: "75px",marginTop: "-12%", borderRadius: "50%",padding:'2px'}} className='bg-white mx-auto'>  <img src={pro} className="  mohamed2"/></div>
                    <a  className="m-0 p-0 a" ><h5 className="text-center my-3">mohamed walid</h5></a>

                </div>
                <div className="card mt-2 " style={{position:"relative" , position:"sticky", top:"10%"}}>
                    <a  className="text-primary py-1 px-2 a">groups</a>
                    <a  className="text-primary py-1 px-2 a">events</a>
                    <a  className="text-primary py-1 px-2 a">follow hashtages</a>
                    <hr className="hrfull"/>
            ...
            <div className="col-7">
                <div className="card">
                   ...
                   <div style={{width: "118px",height: "118px",marginTop: "-10%",}} className='bg-white'><img src={pro} className=" logo"/></div>
                ...
                <div className="card ">
                    <div className="px-2 py-3">
                        ...
                        <div className="d-flex mt-3">
                            <div>
                            <img src={friendphoto} className="mo"/>
                            </div>
                            <div className="ms-2">
