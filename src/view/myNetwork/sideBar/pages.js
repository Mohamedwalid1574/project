...
export default function Pages() {
    ...
    return (
        <div className='body'>
            ...
            <div className="container py-3 center">
                <div className="row">
                    <div className="col-md-7 col-sm-12 ">
                       
                        <div className="row row-cols-1 row-cols-md-3  g-0" >
                                <div className="col ">
                                    <div className="card w-100 max-wi px-3 pt-3">
                                        <div >
                                            ...
                                            <hr className="w-25 opacity-25" />
                                            <div className="card-text opacity-75 mex">269.5K followers</div>
                                            <div className='card-footer bg-white border-0 mt-2'>
                                                <p className="text-muted text-center">Following</p>
                                            </div>
