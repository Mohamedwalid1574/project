...
function JobSeekerThird()
{
            ...
            <div>
                ...
                <div className='d-flex es_cards_job'>
                    <div className='es_div5_job'>
                        ...
                        <div  className='card es_card_job es_btn'><a href='#' className='es_link'>3. I want to get a referral</a></div>
                    ...
                    <div className='es_div3_job card'>
                        <h4>I want to get a referral</h4>
                        <p className='es_font4 es_font3'>Job seekers with referrals are<b> 4X more </b>likely to get hired. Asking for a referral isn’t always easy - these short, actionable steps are here to help.</p>
                        <div>
    ...
    <ul>
        ...
        <li className='es_font4 es_font3'>Make sure the person you ask was satisfied with your work.</li>
        <li className='es_font4 es_font3'>If possible, find someone who is a strong and reliable communicator.</li>
    </ul>
                    </div>
