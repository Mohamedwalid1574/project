            ...
            <div>
                ...
                <div className='d-flex es_cards_job'>
                    ...
                    <div className='es_div3_job card'>
                        <h4>I want to improve my LinkedIn Profile page</h4>
                        <p className='es_font4 es_font3'>Learn how to optimize your LinkedIn Profile for recruiters and hiring managers with these simple tips from a career coach and LinkedIn expert.</p>
                        <div>
      <YoutubeEmbed embedId="rokGy0huYEA" />
    </div>
    <h5>Optimize your LinkedIn profile for recruiters (7min)</h5>
    <p>From the course: <a href='#' className='es_link'>  J.T. O’Donnell on Making Recruiters Come to You</a></p>
    <p>Key takeaways</p>
    <ul>
        <li className='es_font4 es_font3'>The top fold is the single most important part of your LinkedIn profile.</li>
        <li className='es_font4 es_font3'>Keywords are important and create density - use them in key areas such as the headline and summary sections.</li>
        <li className='es_font4 es_font3'>Make sure there is continuity and consistency throughout your profile.</li>
    </ul>
                    </div>
...
export default JobSeekersecond;