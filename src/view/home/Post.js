                    ...
                    <div className="m-2 card-body">
                        ...
                        <div>
                            <div className="mt-2 d-flex">
                                <div>
                                    <img style={{ width: '45px', borderRadius:'50%' }} src="https://media-exp1.licdn.com/dms/image/C4E03AQFtWRxo8Uy7vw/profile-displayphoto-shrink_100_100/0/1516320942361?e=1673481600&v=beta&t=uWE2yN0jl_WrqrzhC9KTZSiB3T0gWU6_QqTfmXSh7sU" /> 
                                    {/* <span className="ms-2" style={{ fontWeight: 'bolder' }}>user</span> */}
                                </div>
                                <div className="">
                                    <p className="nada_chat_sender">
