      ...
      <div className="row col-md-10 offset-md-1">
        <div >
          ...
          <form className="NGR-frm  offset-md-4">
            ...
            <input className="NGR-input" id="email" type="email" onChange={(event) => { setsignup(event.target.value) }}></input><br></br>
            <label className="NGR-label">Password (6 or more characters)</label><br></br>
            <input className="NGR-input" id="password" type="password" onChange={(event) => { setpass(event.target.value) }}></input><br></br>
            <p className="NGR-user-copyright">
              By clicking Agree & Join, you agree to the LinkedIn
              <a className="NGR-user-copyrights" href="/#">User Agreement</a>,
              <a className="NGR-user-copyrights" href="/#">Privacy Policy</a>, and
              <a className="NGR-user-copyrights" href="/#">Cookie Policy</a>.
            </p>
            <button className="NGR-agree-btn " id="signup" type="submit" onClick={signup}>Agree & Join</button><br></br>
            <div className='d-flex'>
              <hr className="NGR-hr"></hr>
              <span>&nbsp; &nbsp; &nbsp;or &nbsp; &nbsp; &nbsp;</span>
              <hr  className="NGR-hr"></hr>
            </div>
            <button className="NGR-agree-btn-google" type="submit">Continue with Google<img className="NGR-g-logo" src={G_logo} alt='' /></button>
            <p className="NGR-Already-on-LinkedIn">Already on LinkedIn <a className="NGR-user-copyrights" href="/signin">Sign in</a></p>
          </form>
          <p className="NGR-get-help ">Looking to create a page for a business?<a className="NGR-user-copyrights" href="/#"> Get help </a></p>
        </div>
